...
|:---:|---|---|
| 1 | Funcionário | Visualização limitada dos registros |
| 2 | Diretor | Visualização completa e alteração de registros |
| 3 | Ministro | Controle total, gerenciamento de usuários, exclusões e auditoria |
...
1. A página de login solicita acesso à câmera;
2. O sistema captura uma imagem do usuário;
3. O OpenCV detecta e recorta o rosto;
4. O modelo LBPH compara a imagem com os dados treinados;
5. O usuário correspondente é consultado no MySQL;
6. A sessão é criada com as permissões do cargo identificado;
7. A tentativa de acesso é registrada para auditoria.
